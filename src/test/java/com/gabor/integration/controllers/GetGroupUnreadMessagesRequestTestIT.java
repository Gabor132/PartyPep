...
@IntegrationTestConfiguration(path = RequestPathEnum.GET_GROUP_MESSAGES, hasBoolean = true)
public class GetGroupUnreadMessagesRequestTestIT extends AbstractGetRequestTest<MessageDTO> {
