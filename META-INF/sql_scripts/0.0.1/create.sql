...
CREATE TABLE EVENTS (ID SERIAL PRIMARY KEY, NAME VARCHAR(255) NOT NULL, EVENT_START TIMESTAMP NOT NULL, CREATION_USER BIGINT NOT NULL, LOCATION VARCHAR(255) NOT NULL, FOREIGN KEY(CREATION_USER) REFERENCES USERS(ID));
